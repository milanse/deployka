...
Процедура УстановитьСтатусБлокировкиСеансов(Знач Блокировать)
	...
	КомандаВыполнения = СтрокаЗапускаКлиента() + СтрШаблон("infobase update --infobase=""%3""%4 --cluster=""%1""%2 --scheduled-jobs-deny=%5 --sessions-deny=%5 --denied-message=""%6"" --denied-from=""%8"" --denied-to=""%9"" --permission-code=""%7""",
		...
		ВремяБлокировки,
		мНастройки.ВремяОкончанияБлокировки) + " "+мНастройки.АдресСервераАдминистрирования;
