...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды) Экспорт
	...
	РазрешитьДинамическоеОбновление = ПараметрыКоманды["-allow-dynamic"];
	...
	Попытка
		Конфигуратор.ОбновитьКонфигурациюБазыДанных(Не ПредупрежденияВозможны,Истина,РазрешитьДинамическоеОбновление);
