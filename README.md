...
* -lockend - Время окончания блокировки пользователей, время указываем как '2040-12-31T23:59:59', если параметр не указано - очищается существующее
* -include-scheduled-jobs - Включает управление блокировкой регламентных заданий 
